...
describe('NavBar', () => {
    ...
    it('should render in logged in state', async() => {
        ...
        expect(screen.getByTestId('navbar-items').children).toHaveLength(9);
        expect(screen.getByTestId('navbar-home')).toBeInTheDocument();
        expect(screen.getByTestId('navbar-courses')).toBeInTheDocument();
        expect(screen.getByTestId('navbar-pricing')).toBeInTheDocument();
